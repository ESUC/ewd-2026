...
ASSIGNMENTS = [
    ...
    ("aifs", "34", [34], "ece", "Electrical and Computer Engineering"),
    ("qcsa", "35", [35], "ece", "Electrical and Computer Engineering"),
    ("3d4e", "36", [36], "ece", "Electrical and Computer Engineering"),
    ("bes", "37", [37], "mae", "Mechanical and Aerospace Engineering"),
    ("beam", "38", [38], "mae", "Mechanical and Aerospace Engineering"),
    ("asme", "39", [39], "mae", "Mechanical and Aerospace Engineering"),
    ("bruinspace", "40", [40], "mae", "Mechanical and Aerospace Engineering"),
    ("bfr", "41", [41], "mae", "Mechanical and Aerospace Engineering"),
    ("smv", "42", [42], "mae", "Mechanical and Aerospace Engineering"),
    ("baja_sae", "43", [43], "mae", "Mechanical and Aerospace Engineering"),
    ("uas", "44", [44], "mae", "Mechanical and Aerospace Engineering"),
    ("dbf", "45", [45], "mae", "Mechanical and Aerospace Engineering"),
    ("rocket_project", "46", [46], "mae", "Mechanical and Aerospace Engineering"),
    ("aiaa", "47", [47], "mae", "Mechanical and Aerospace Engineering"),
]
...
NEW_ORGS = {
    ...
    "aifs": base_org(
        id="aifs",
        full_name="AI for Safety",
        short_name="",
        description="AI for Safety is a student organization exploring safe, reliable, and responsible AI. Come by to learn about research, projects, and how to get involved.",
        website="",
        instagram="",
    ),
    "qcsa": base_org(
